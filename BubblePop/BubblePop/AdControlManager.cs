    ...
    public class AdControlManager
    {
        ...
        public AdControlManager(GameComponentCollection Components, bool testMode = true)
        {
            ...
            if (adType == AdControlType.MSFT)
            {
                if (testMode)
                {
                    AdGameComponent.Initialize(BubblePop.Instance, "test_client");
                }
                else
                {
                    AdGameComponent.Initialize(BubblePop.Instance, "8b59a479-d759-47b9-91d1-232bdd383f82");
                }
        ...
        public void Load()
        {
            ...
            {
                adView = new MMAdView(BubblePop.graphics.GraphicsDevice, new Vector2(0, 720), AdPlacement.BannerAdTop);
                adView.Apid = "60242";
            ...
            {
                adDuplex = new AdManager(BubblePop.Instance, "9827");
                adDuplex.LoadContent();
                adDuplex.RefreshInterval = 30;
            }
#endif

            defaultAd = BubblePop.Instance.Content.Load<Texture2D>("Textures/DefaultAd");
        }
        ...
        public void Draw(GameTime gameTime)
        {
            ...
            if (showAds)
            {
                ...
                SpriteBatch spriteBatch = BubblePop.screenManager.SpriteBatch;
